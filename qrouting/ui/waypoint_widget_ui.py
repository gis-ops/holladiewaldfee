...
class Ui_WaypointWidget(object):
    ...
    def retranslateUi(self, WaypointWidget):
        ...
        self.add_wp.setToolTip(_translate("WaypointWidget", "Add waypoints by clicking on the map canvas (end selection with double click)."))
        self.add_wp.setText(_translate("WaypointWidget", "..."))
        self.remove_wp.setToolTip(_translate("WaypointWidget", "Remove selected or all waypoints from the table."))
        self.remove_wp.setText(_translate("WaypointWidget", "..."))
        self.add_from_layer.setToolTip(_translate("WaypointWidget", "Load waypoints from one of the current project\'s point layers."))
        self.add_from_layer.setText(_translate("WaypointWidget", "..."))
        self.move_up.setToolTip(_translate("WaypointWidget", "Move selected point one position up."))
        self.move_up.setText(_translate("WaypointWidget", "..."))
        self.move_down.setToolTip(_translate("WaypointWidget", "Move selected point one position down."))
