...
from .gui.qrouting_dialog import QRoutingDialog
import os.path
...
class QRouting:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.from_map_button.clicked.connect(self._on_map_click_from)
            self.dlg.to_map_button.clicked.connect(self._on_map_click_to)
    ...
    def _write_line_widget_to(self, point: QgsPointXY):
        self.dlg.to_xy.setText(f"{point.y():.6f}, {point.x():.6f}")
        self._write_line_widget()
